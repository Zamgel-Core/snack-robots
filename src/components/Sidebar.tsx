  ...
  return (
    <nav className="w-[240px] flex flex-col gap-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-[32px] p-6 shadow-2xl flex-shrink-0 relative overflow-y-auto">
      <div className="flex flex-col items-center gap-2 mb-8 text-center">
        ...
        <div>
          <p className="text-[10px] font-black text-yellow-300 opacity-90 italic uppercase tracking-widest drop-shadow">
              ...
              {({ isActive }) => (
                <>
                  <Icon
                    className={cn(
                      "w-5 h-5",
                      isActive ? "text-blue-600" : "opacity-70",
                    )}
                  />
                  {link.name}
                </>
      ...
      <div className="mt-auto p-4 bg-black/20 rounded-2xl border border-white/5 mt-4">
        <p className="text-[10px] uppercase font-bold text-blue-200 tracking-widest mb-1">
          Rol Actual
        </p>
